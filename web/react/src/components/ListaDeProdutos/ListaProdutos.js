...
export class Product extends Component {
    ...
    constructor() {
        ...
        search(Li.Col.id){
            switch (id) {
                case 1:
                    this.setState(<Col md={11} className="bordList mb-2" id="play" >
                        <Container className="themed-container " fluid={true}  >
                            <Row >
                                <Col md={3} id="1">

                                    <CardImg className="p-3" width="100%" src={p.img} alt={p.name} title={p.name} />
                                </Col>
                                ...
                                <Col md={2} className="productPrice ">
                                    <span className="p-4"> {p.price}</span>
                                </Col>
